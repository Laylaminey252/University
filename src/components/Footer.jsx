    ...
    <section className="py-10 bg-blue-950 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-4 md:gap-x-12">
          ...
          <div>
            <p className="text-base text-gray-500">Academics</p>
          ...
          <div>
            <p className="text-base text-gray-500">Connect</p>
        ...
        <div className="flex flex-wrap items-center justify-between">
          ...
          <p className="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto">
            © Copyright 2024, All Rights Reserved by University
          </p>
        </div>
      </div>
    </section>
